...
class DeveloperAttractionRetention(MetricsModel):
    ...
    # active C0_users in last 90 days 
    ...
    # active D0_users in last 90 days 
    ...
    # active D1_users in last 90 days 
    ...
    # active C1_users in last 90 days 
    ...
    # The cout of contributor who contributes more than twice
